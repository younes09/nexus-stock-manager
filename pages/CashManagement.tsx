...
const CashManagement: React.FC<Props> = () => {
    const { t } = useLanguage();
    const { state, addCashTransaction, deleteCashTransaction, showDialog, fetchCash, isSyncing } = useAppContext();
    const { data: transactions, pagination } = state.cashTransactions;
                                    ...
                                    <div className="text-right">
                                        ...
                                        <button
                                            onClick={() => showDialog({
                                                ...
                                                onConfirm: () => deleteCashTransaction(t_item.id),
                                                variant: 'danger'
                                            })}
                                ...
                                <div>
                                    ...
                                    <div className="grid grid-cols-2 gap-3">
                                        <button
                                            ...
                                            className={`py-3 rounded-2xl font-bold transition-all border-2 ${formData.type === 'income'
                                        ...
                                        <button
                                            ...
                                            className={`py-3 rounded-2xl font-bold transition-all border-2 ${formData.type === 'expense'
                ...
                <div className="flex items-center justify-between bg-white px-8 py-5 rounded-2xl border border-slate-200 mt-6 shadow-sm">
                    ...
                    <div className="flex items-center gap-2">
                        <button
                            ...
                            onClick={() => fetchCash(pagination.page - 1, pagination.limit || 50)}
                        ...
                        <div className="flex items-center gap-1">
                            {Array.from({ length: pagination.totalPages }, (_, i) => i + 1).map(p => (
                                <button
                                    key={p}
                                    disabled={isSyncing}
                                    onClick={() => fetchCash(p, pagination.limit || 50)}
